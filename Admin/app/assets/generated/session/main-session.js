...
import SessionListElement from './list.js';


export default class MainSessionElement extends LitElement {
    static properties = { }
    static get styles() { }
...
customElements.define('app-main-session', MainSessionElement);